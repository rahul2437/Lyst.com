               ...
               <div className="card">
                    <div className="card1">
                         ...
                         <p>
                              ...
                              <br />
                              <br /> Find exactly what you want with powerful
                              search and personal recommendations.
                         </p>
                    </div>
                    <div className="card2">
                         <h1>2</h1>
                         ...
                         <p>
                              ...
                              <br /> Hit the heart to recieve alerts on the
                    ...
                    <div className="card3">
                         ...
                         <p>
                              Compare preces and shipping options across
                              thousands of stores. <br />
                              <br />
                              Lyst members are notified when an item goes on
                              sale.
                         </p>
                    </div>
                    <div className="card4">
