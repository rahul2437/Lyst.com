...
const Homepage = () => {
     return (
          <Container>
               <PortFolio>
                    <Poster
                         src="https://cdna.lystit.com/cms/ENG_header_desktop_bddf9b3474_884ff704d3.jpg"
                         alt="poster"
                    />
                    <Poster1
                         src="https://cdna.lystit.com/cms/ENG_header_desktop_bddf9b3474_884ff704d3.jpg"
                    ...
                    />
                    <Poster2
                         src="https://cdna.lystit.com/cms/ENG_header_tablet_test_40933dc911.jpg"
                         alt="tablet-poster"
                    />
                    <Poster3
                         src="https://cdna.lystit.com/cms/ENG_header_mobile_test_a391a0431f.jpg"
                         alt="mobile-poster"
                    />
               </PortFolio>
               <Slide />
                    ...
                    <Offers>
                         <List>
                              <ListItem>
                                   ...
                                   <ListPara>
                                        Shop over 12,000 brands and stores in
                                        one place.
                                   </ListPara>
                                   <ListPara>
                                        Find exactly what you want with powerful
                                        searchh and personal recommendations.
                                   </ListPara>
                              </ListItem>
                              <ListItem>
                                   <Num>2</Num>
                                   ...
                                   <ListPara>
                                        Hit the heart to receive alerts on the
                                        latest drops from your favourite brands.
                                   </ListPara>
                              </ListItem>
                              <ListItem>
                                   <Num>3</Num>
                                   ...
                                   <ListPara>
                                        Lyst members are notified when an item
                                        goes on sale.
                                   </ListPara>
                              </ListItem>
                         </List>
