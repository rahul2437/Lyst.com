...
const ProductCard = ({ item }) => {
  ...
  const { imgurl, brand, category, color, mrp, title, price, desc, id } = item;
          ...
          <ModalContent>
            <ModalBody>
              <ProductDiv>
                ...
                <img style={{}} width="300px" src={imgurl} alt={title} />
                <div style={{ width: "300px" }}>
                  ...
                  <div className="flex items-center mb-1">
                    <p className="text-[#f9302d] font-extrabold text-2xl">
                      Price {"  "}
                      <Text as={"s"}>${mrp}</Text> ${price}
                    </p>
                  </div>
                  <Text mt={2} fontSize={"l"} className="text-sm text-gray-500">
                    From{" "}
                    <span
                      style={{
                        fontWeight: "bold",
                  ...
                  <div
                    ...
                    onClick={() => {
                      console.log("i will check login ");
                      // if (isLoggedIn) {
                      //   addToCart();
                      //   handleClick();
                      // } else {
                  ...
                  >
                    <AddToCartBtn
                      onClick={() => {
                        dispatch(addToCart({ id, title, imgurl, price }));
                      }}
                    >
                      Add to cart
                    </AddToCartBtn>
